...
<link rel="stylesheet"
    ...
    <meta name="webSocketPath" content="<c:url value="/ticTacToe/${1}/${'bowei'}">
        <c:param name="action" value="${'start'}" />
    </c:url>">
    <meta name="gameId" content="1"/>
    <meta name="username" content="bowei"/>
    <meta name="action" content="start"/>
</head>
<body>
